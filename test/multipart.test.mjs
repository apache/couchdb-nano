...
import  MultiPartFactory from '../lib/multipart.mjs'
...
test('should return different boundary each time', async () => {
  ...
  assert.equal(mf1.boundary.length, 36)
  assert.equal(mf2.boundary.length, 36)
  assert.equal(mf3.boundary.length, 36)
